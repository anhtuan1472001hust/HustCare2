...
public class MainExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.textToSpeech=new TextToSpeech(getApplicationContext(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int i) {
                if(i!=TextToSpeech.ERROR){
                    MainExerciseActivity.this.textToSpeech.setLanguage(Locale.US);
                }
            }
        });
        ...
        this.restButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (MainExerciseActivity.this.isSpeaking()) {
                    MainExerciseActivity.this.stop();
                }
    ...
    public void restExcTimer(long j) {
        ...
        if(j==this.m) {
            ...
            sb3.append("take a rest ");
            this.speak(sb3.toString());
        }
        ...
        CountDownTimer countDownTimer2=new CountDownTimer(j,1000) {
            ...
            public void onTick(long j) {
                ...
                if(j3==7) {
                    ...
                    MainExerciseActivity.this.speak(sb2.toString());
                }
                if (j3 < 4) {

                    if (j3 == 3) {
                        MainExerciseActivity.this.speak("three ");
                    }
                    if (j3 == 2) {
                        MainExerciseActivity.this.speak("two ");
                    }
                    if (j3 == 1) {
                        MainExerciseActivity.this.speak("one ");
                    }
                    if (j3 == 0 && !MainExerciseActivity.this.F.booleanValue()) {
        ...
        CountDownTimer r2=new CountDownTimer(j,1000) {
            ...
            public void onTick(long j) {
                ...
                if(j3==9){
                    ...
                    MainExerciseActivity.this.speak(sb6.toString());
                }
                if(j3<4) {
                    if (j3 == 3) {
                        MainExerciseActivity.this.speak("three ");
                    ...
                    if (j3 == 0 && !MainExerciseActivity.this.G.booleanValue()) {
                        ...
                        MainExerciseActivity.this.speak("go ");
    ...
    public void speak(String str){
            ...
            this.textToSpeech.speak(str,TextToSpeech.QUEUE_FLUSH,null);
    }
    public void stop() {
    ...
    public void mainExcTimer(long j1) {
        WorkoutData workoutData = this.workoutDataList.get(excCounter);
        ...
        CountDownTimer mainExcCountDownTimer = new CountDownTimer(j1, 1000) {
            ...
            public void onTick(long j1) {
                String str3 = "";
                String str="";
                if(this.b < MainExerciseActivity.this.workoutDataList.get(MainExerciseActivity.this.excCounter).getExcCycles()){
                    int i3=this.b;
                    this.b=i3+1;
                }
                this.c=this.b;
                ...
                long j4=j3/1000;
                if(j4==((MainExerciseActivity.this.workoutDataList.get(excCounter).getExcCycles())-2)){
                    StringBuilder stringBuilder7=new StringBuilder();
                    stringBuilder7.append(MainExerciseActivity.this.workoutDataList.get(excCounter).getExcName());
                    stringBuilder7.append(str8);
                    stringBuilder7.append(MainExerciseActivity.this.workoutDataList.get(excCounter).getExcCycles());
                    stringBuilder7.append(str8);
                    stringBuilder7.append("seconds ");
                    MainExerciseActivity.this.speak(stringBuilder7.toString());
                }
                String str5= getResources().getString(MainExerciseActivity.this.workoutDataList.get(excCounter).getExcDescResId());
                if(j4==((MainExerciseActivity.this.workoutDataList.get(excCounter).getExcCycles())-8)){
                    StringBuilder stringBuilder9=new StringBuilder();
                    stringBuilder9.append(str5);
                    stringBuilder9.append(str8);
                    MainExerciseActivity.this.speak(stringBuilder9.toString());
                }
                if(j4<4) {
                    if (j4 == 3) {
                        MainExerciseActivity.this.speak("three ");
